...
ML_ALGO_LIST = c( 'NSGA2_LR_AUC_average_churn_recall_median',
                 'NSGA3_LR_AUC_average_churn_recall_median',
                  'AGEMOEA_LR_AUC_average_churn_recall_median')
...
write.csv(results_popt,paste(DATA_PATH,'/','popt_desc_2.csv',sep=''), row.names = FALSE)
write.csv(results_recall_at_02,paste(DATA_PATH,'/','recall_at_02_desc_2.csv',sep=''), row.names = FALSE)
write.csv(results_auc,paste(DATA_PATH,'/','auc_desc_2.csv',sep=''), row.names = FALSE)